...
class ResultController extends Controller
{
     ...
     *  @param bool $doboon_check: doboonが存在するかチェックする
     *  @param string  $doboon : doboonが存在したらtrue('game_over')、存在しなかったらfalse('clear')
     *  @param string $kana1,$kana2,$kana3 : demon_kanaのセッション情報
     *  @param array $demon_kana_all : demon_kanaを配列にまとめたもの
     *
     */
